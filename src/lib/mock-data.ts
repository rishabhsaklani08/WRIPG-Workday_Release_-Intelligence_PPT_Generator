...
export const mockFeatures: WorkdayFeature[] = [
  {
    ...
    complexity: 'High', setupEffort: 'Setup Required', optIn: false,
  ...
  },
  {
    ...
    releaseVersion: 'Workday 2026 Release 1', releaseShort: '2026R1',
    complexity: 'Low', setupEffort: 'Automatically Available', optIn: false,
    documentationUrl: '', tenant: 'Production', productionDate: '2026-02-06',
  },
  {
    ...
    releaseVersion: 'Workday 2026 Release 1', releaseShort: '2026R1',
    complexity: 'Medium', setupEffort: 'Setup Required', optIn: true,
